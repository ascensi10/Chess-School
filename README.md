...
**Mandatory Study Order: Endgame → Tactics → Positional Understanding → Opening**
...
- [Elementary School](#elementary-school-beginner)
- [Middle School](#middle-school-intermediate)
- [High School](#high-school-level-advanced)
- [University Level](#university-level-professional)
- [Graduate Level](#graduate-level-cmfm)
- [Doctoral Level](#doctoral-level-imgm)

---

### Core Philosophy

The Soviet School does not start with openings.

1.  **Endgame First:** With few pieces, the student learns piece coordination, King activity, Opposition, Zugzwang, and Key Squares.
2.  **Tactics Second:** Calculation is the foundation. Forced lines are studied before motifs.
3.  **Positional Understanding Third:** After calculation is established, piece placement, center control, and pawn structures are studied.
4.  **Opening Last:** The opening is a means to reach a playable middlegame.

### Study Methodology

**Required Protocol:**
- Calculate with eyes before moving.
- After solving, flip the board and solve from the opponent's perspective.
- Solve without hints.
...
6. [Opposition (Theory)](https://www.youtube.com/watch?v=n3FufrVltsc)
...
5. [Mate in 3 (x40)](https://lichess.org/training/mateIn3)
6. [Pin: Learn](https://www.youtube.com/watch?v=DzoEqql2x5Q)
   - [Pin Puzzles (x30)](https://lichess.org/training/pin)
7. [Fork: Learn](https://www.youtube.com/watch?v=HNFR315mdxA)
   - [Fork Puzzles (x31)](https://lichess.org/study/LHqzFKNI/kTwaPWEx)
8. [Skewer](https://www.youtube.com/watch?v=0GPMzLS-u3A)
   - [Skewer Puzzle (x30)](https://lichess.org/training/skewer)
9. [Discovered Attack](https://www.youtube.com/watch?v=-MSZCCuRz88)
   - [Practice](https://lichess.org/training/discoveredAttack)
10. [Removing Defender](https://www.youtube.com/watch?v=QXGngjKuOeI)
    - [Puzzles (x30)](https://lichess.org/training/capturingDefender)
11. [Deflection: Learn](https://www.youtube.com/watch?v=JTqV6mucGKQ)
    - [Deflection Puzzles (x30)](https://lichess.org/training/deflection)
...
- - [Knight And Bishop Mate](https://www.youtube.com/watch?v=dHnz4U7qjfk)
  - [Practice](https://www.chess.com/endgames/checkmates/bishop-and-knight-mate/practice)
...
- Triangulation and Corresponding Squares
...
- [Good knight VS bad bishop](https://www.youtube.com/watch?v=wgVDmt2F1w0)
...
- Edge-pawn Lucena variants
- Opposite-colored bishop draws
- Zugzwang in Rook endgames
- Queen endgame checking sequences
- Rook lifts
...
- Calculation depth
- Preconditions for combinations
...
- Multiple passed pawn races
- Bishop and knight combinations
- Knight and knight endgames
- Queen and pawn vs. queen
- The Tarrasch rule
- The fifty-move rule

#### 2. Tactics
- Kotov's calculation tree
- Candidate moves
- Blind calculation
- Multi-layered combinations
- Tactics-strategy synthesis
- Defensive tactics
...
#### 4. Opening
- Repertoire depth
- Opening-to-middlegame transitions
- Comparative opening evaluation
...
- Endgame-based exchange evaluation
- Complex pawn endgame calculation
- Rare theoretical positions
- Technique under time pressure

#### 2. Tactics
- Time-trouble analysis
- Comparing alternative combinations
- Avoiding miscalculation
- Converting initiative into pressure
- Worst-case scenario analysis

#### 3. Positional Understanding
- Complete position evaluation methodology
- Plan selection in unbalanced positions
- Dynamic vs. static factor weighing
- Plan selection based on the opponent
...
- Study-level endgame motifs
- Practical vs. theoretical accuracy
- Deliberate endgame steering

#### 2. Tactics
- Intuitive tactical alarm
- Original combinational motifs
- Tactics and opponent psychology
- Aesthetic and study-level depth

#### 3. Positional Understanding
- Intuitive positional evaluation
- Personal strategic style
- Exceptional and rule-breaking positions
- Opponent-psychology-based positional choice

#### 4. Opening
- Original contributions to theory
- Dynamic repertoire management
- Critical evaluation of trends
- Psychological factors in preparation
